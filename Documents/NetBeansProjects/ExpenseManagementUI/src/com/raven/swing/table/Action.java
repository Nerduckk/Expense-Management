...
public class Action extends javax.swing.JPanel {
    ...
    private final ModelAction data;
    ...
    public Action(ModelAction data) {
        ...
        cmdEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (Action.this.data.getEvent() != null && Action.this.data.getTransaction() != null) {
                    Action.this.data.getEvent().update(Action.this.data.getTransaction());
                }
            }
        });
        ...
        cmdDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (Action.this.data.getEvent() != null && Action.this.data.getTransaction() != null) {
                    Action.this.data.getEvent().delete(Action.this.data.getTransaction());
                }
            }
        });
    }
